            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                @csrf                                    
                    <div class="mb-6">
                        ...
                        <input class="block text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 light:text-gray-400 focus:outline-none light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400" id="file_input" name="file_input" type="file">
